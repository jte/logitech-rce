...
//
// This function display/close a window when user click a link. eg. licence agreement
//
var title = "";
...
var title2 = "";
	function fadeIn2() {	
		GamingWarning.style.filter="blendTrans(duration=0.01);";
      ...
      if (el != null) {
	    ...
	    if (GamingWarning.filters.blendTrans.status != 2) {
	        GamingWarning.filters.blendTrans.apply();
	        GamingWarning.style.visibility="visible";
	        GamingWarning.filters.blendTrans.play();
	    }
		toggleBlanket(true);
	...
	function fadeOut2() {
	    ...
	    if (GamingWarning.filters.blendTrans.status != 2) {
	        GamingWarning.filters.blendTrans.apply();
	        GamingWarning.style.visibility="hidden";
	        GamingWarning.filters.blendTrans.play();
	    }
		toggleBlanket(false);
...
var title3 = "";
	function fadeIn3() {	
		ChooseLanguage.style.filter="blendTrans(duration=0.01);";
			var el = document.getElementById("H1");
      if (el != null) {
        if (title3.length != 0) {
          el.innerText=title3; }
	    ...
	    // Make sure the filter is not playing.
	    if (ChooseLanguage.filters.blendTrans.status != 2) {
	        ChooseLanguage.filters.blendTrans.apply();
	        ChooseLanguage.style.visibility="visible";
	        ChooseLanguage.filters.blendTrans.play();
	    }
		toggleBlanket(true);
	}
	...
	function fadeOut3() {
	    ...
	    if (ChooseLanguage.filters.blendTrans.status != 2) {
	        ChooseLanguage.filters.blendTrans.apply();
	        ChooseLanguage.style.visibility="hidden";
	        ChooseLanguage.filters.blendTrans.play();
	    }
		toggleBlanket(false);
	}	
