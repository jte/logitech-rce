...
enum LD_EVENT
{
	...
	/*
	0x03000016  Elvado2Receiver
0x03000017  Koala2dReceiver
0x03000020  Wallaby LS
0x03000021  Wallaby FS
0x03000029  Safari
0x0300002B  Kigoi
0x0300002C  Kiwi
0x0300002E  Nano eQuad
0x03000031  Kiwi DT Uni
0x03000033  Gourami
0x03000034  Bicky
0x03000035  Kenny
0x03000036  Pacer-X
...
typedef struct _LD_GET_BATTERY_STATUS_INFO
{
	DWORD dwSize;
	DWORD dwInfo;
	DWORD dwBatteryStatus;
} LD_GET_BATTERY_STATUS_INFO;

typedef struct _LD_GETSET_REGISTER_INFO
{
	DWORD pad1;
	DWORD flags;
	BYTE Address;
	...
	DWORD* lpOut;
	DWORD* lpBuf;
} LD_GETSET_REGISTER_INFO;

typedef void (__cdecl *DeviceDumpCallback)(int/*Extra1*/, int/*Extra2*/, int/*Extra3*/, int/*Prefix*/, DWORD/*Name*/, DWORD/*Type*/, \
			signed int, signed int, int/*Value*/);

typedef struct _LD_DEVICE_DUMP
{
	DeviceDumpCallback pCallback;
	DWORD Extra1;
	DWORD Extra2;
	DWORD Extra3;
} LD_DEVICE_DUMP;

typedef struct _LD_DEVICE_WRITE_INFO
{
	DWORD dwSize;
	DWORD* lpBuffer;
} LD_DEVICE_WRITE_INFO;
